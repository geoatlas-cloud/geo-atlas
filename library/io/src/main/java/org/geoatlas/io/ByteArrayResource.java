...
/** repackage from org.geowebcache.io.ByteArrayResource
 *
 * @author: <a href="mailto:thread.zhou@gmail.com">Fuyi</a>
 * @time: 2024/4/21 10:47
 * @since: 1.0
 **/
...
//            Assert.isTrue(offset < data.length, "Offset should be less than data length");
            if (offset > data.length) {
                throw new RuntimeException("Offset should be less than data length");
            }
//            Assert.isTrue(offset + length <= data.length, "Offset + length should be less than length");
            if (offset + length > data.length) {
                throw new RuntimeException("Offset + length should be less than length");
            }
            this.offset = offset;
            this.length = length;
        }
    ...
    /** @see org.geoatlas.io.Resource#transferTo(java.nio.channels.WritableByteChannel) */
    @Override
    ...
    /** @see org.geoatlas.io.Resource#transferFrom(java.nio.channels.ReadableByteChannel) */
    @Override
    ...
    /** @see org.geoatlas.io.Resource#getInputStream() */
    @Override
    ...
    /** @see org.geoatlas.io.Resource#getOutputStream() */
    @Override
