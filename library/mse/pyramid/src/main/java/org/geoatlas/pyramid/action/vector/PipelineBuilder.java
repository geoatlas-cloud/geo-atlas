...
import org.geoatlas.base.helper.MathTransformHelper;
...
/**
 * repackage from org.geoserver.wms.vector.PipelineBuilder
 *
 * @author: <a href="mailto:thread.zhou@gmail.com">Fuyi</a>
 * @time: 2024/4/24 14:22
 * @since: 1.0
 **/
public class PipelineBuilder {
    ...
    private static Context createContext(
        ...
        context.sourceToTargetCrs = MathTransformHelper.buildTransform(sourceCrs, mapCrs);
