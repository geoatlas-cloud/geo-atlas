...
public class MatrixAlignmentMismatchException extends MatrixMismatchException {

    public MatrixAlignmentMismatchException(double x, long posX, double y, long posY) {
        super(
