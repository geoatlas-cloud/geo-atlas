...
/**
 * repackage from org.geowebcache.grid.BoundingBox
 * <p>
 * - 变更Logger
 * </p>
 * @author: <a href="mailto:thread.zhou@gmail.com">Fuyi</a>
 * @time: 2024/4/20 15:39
 * @since: 1.0
 **/
public class BoundingBox implements Serializable {
    ...
    private static final Logger log = LoggerFactory.getLogger(BoundingBox.class.getName());
    ...
    public BoundingBox(String BBOX) {
        ...
        if (log.isDebugEnabled()) {
            log.debug("Created BBOX: " + getReadableString());
        }
    }
