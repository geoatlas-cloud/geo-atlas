...
public class FileBlobStoreInfo extends BlobStoreInfo {
    ...
    @Override
    public BlobStore createInstance(LockProvider lockProvider)
            ...
            fileBlobStore =
                    new FileBlobStore(
                            ...
                            new XYZFilePathGenerator(
                                    baseDirectory, XYZFilePathGenerator.Convention.TMS));
        } else {
            fileBlobStore =
                    new FileBlobStore(
                            baseDirectory,
                            new XYZFilePathGenerator(
                                    baseDirectory, XYZFilePathGenerator.Convention.XYZ));
        }
