...
/** */
public abstract class TileTask {

    private static final Logger log = Logging.getLogger(TileTask.class.getName());
     ...
     */
    public final void doAction() throws GeoAtlasCacheException, InterruptedException {
    ...
    protected abstract void doActionInternal() throws GeoAtlasCacheException, InterruptedException;
