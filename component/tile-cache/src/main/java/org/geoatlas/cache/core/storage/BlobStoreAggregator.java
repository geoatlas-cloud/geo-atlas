...
import org.geoatlas.cache.core.config.BlobStoreConfiguration;
import org.geoatlas.cache.core.config.BlobStoreConfigurationListener;
import org.geoatlas.cache.core.config.BlobStoreInfo;
import org.geoatlas.cache.core.config.ServerConfiguration;
import org.geoatlas.cache.core.config.meta.ServiceInformation;
import org.geoatlas.cache.core.util.CompositeIterable;
...
//    private TileLayerDispatcher layers;
     ...
     *
     * @throws GeoAtlasCacheException if no such blob store info exists
     */
    public BlobStoreInfo getBlobStore(final String blobStoreName) throws GeoAtlasCacheException {
    ...
    public void reInit() {
        List<BlobStoreConfiguration> extensions =
                GeoAtlasCacheExtensions.extensions(BlobStoreConfiguration.class);
