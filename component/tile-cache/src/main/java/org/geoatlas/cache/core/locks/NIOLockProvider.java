...
import org.geoatlas.cache.core.storage.DefaultStorageFinder;
import org.geoatlas.cache.core.config.ConfigurationException;
import org.geoatlas.cache.core.util.IOUtils;
...
public class NIOLockProvider implements LockProvider {
    ...
    public LockProvider.Lock getLock(final String lockKey) throws GeoAtlasCacheException {
        File file = null;
        ...
        try {
            ...
            try {
                ...
                if (count >= maxLockAttempts) {
                    throw new GeoAtlasCacheException(
