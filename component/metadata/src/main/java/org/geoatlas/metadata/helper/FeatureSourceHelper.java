...
public class FeatureSourceHelper {
    ...
    public FeatureSourceConveyor getFeatureSource(String namespace, String layerName) {
        // read namespace info
        ...
        try {
            ...
            return new FeatureSourceConveyor(dataStore.getFeatureSource(featureLayerInfo.getView().getName()),
